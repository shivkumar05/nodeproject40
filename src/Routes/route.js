...
Router.get("/getCustomExercise", battingController.getCustomExercise);
Router.post("/:userId/Customdrills", commnMid.jwtValidation, commnMid.authorization, battingController.CustomDrill);
Router.get("/getcustomdrillUser", battingController.getcustomdrillUser);
Router.post(
  "/:userId/deleteWorkout",
  commnMid.jwtValidation,
  commnMid.authorization,
  battingController.deleteWorkout
);
Router.post(
  "/:userId/deleteExercise",
  commnMid.jwtValidation,
  commnMid.authorization,
  battingController.deleteExercise
);
Router.post(
  "/:userId/deleteDrill",
  commnMid.jwtValidation,
  commnMid.authorization,
  battingController.deleteDrill
);
Router.put(
  "/:userId/updateRoutineField",
  commnMid.jwtValidation,
  commnMid.authorization,
  battingController.updateRoutineField
);
Router.get(
  "/:userId/getWorkoutExercise",
  commnMid.jwtValidation,
  commnMid.authorization,
