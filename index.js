...
app.post(
  ...
  async (req, res) => {
    try {
      ...
      obj["drill_id"] = MyDrillCreated.drill_id;
...
app.post(
  ...
  async (req, res) => {
    try {
      ...
      // let dataArray = [];
      // dataArray.push(myDrillsCreated);
...
app.post(
  "/:userId/createexercises",
  commnMid.jwtValidation,
  commnMid.authorization,
  async (req, res) => {
    try {
      const { userId } = req.params;
      const exerciseDataArray = req.body;

      const exercises = exerciseDataArray.map((exerciseData) => {
        exerciseData.userId = userId;
        return exerciseData;
      });

      const createdExercises = await ExerciseModel.create(exercises);
